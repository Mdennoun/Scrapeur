...
int main(void)
{
  ...
  if(res != CURLE_OK) {
    ...
    char* configPath = "/Users/mohameddennoun/Desktop/ProjetC/scrappeur/Websites/Google/google.html";
    ...
    if( website != NULL) {
        ...
        printf("test passed");
        fclose(website);
        printf("%d", Search_in_File("/Users/mohameddennoun/Desktop/ProjetC/scrappeur/Websites/Google/google.html", "href=\""));
    } else {
        printf("file is null");
    }
...
char *CheckUrl(char *url, int size, char *domain, int domainSize) {
    ...
    if(url[0] == '/') {
        ...
        if((url[(size - 5)] == '.') && url[(size - 6)] == '.') {
            
            printf("yeah 88!\n");
        }
        strcat(checkedUrl, url);
        free(checkedUrl);
        printf("checkedUrl : %s", checkedUrl);
        return checkedUrl;
    } else if(url[0] == 'h' || (url[0] == 'w')) {
        if(url[size - 3] == ';') {
        printf("yes\n");
        char *checkedUrl;
...
void DownloadImages(char *filePath, char* domain, int domainSize) {
    ...
    char c;
    char *outpicturename;
    char *outfilename = "/Users/mohameddennoun/Desktop/ProjetC/scrappeur/Websites/Google/saveimage";
